...
void glcd_setpixel(uint8_t x,uint8_t y,uint8_t c)
{
    ...
    LATB&=~(0b00000100);
    PORTD=((uint8_t)(0b10111000|((y>>3)&7)));
    LATB|=(0b00010000);
    _delay((unsigned long)((8)*(8000000/4000000.0)));;
    LATB&=~(0b00010000);
    _delay((unsigned long)((8)*(8000000/4000000.0)));;
    PORTD=((uint8_t)(0b01000000|(x&0x3f)));
    LATB|=(0b00010000);
    _delay((unsigned long)((8)*(8000000/4000000.0)));;
    LATB&=~(0b00010000);
    _delay((unsigned long)((8)*(8000000/4000000.0)));;
...
void glcd_systext(uint8_t x,uint8_t y,const char *tx,uint8_t c)
{
    ...
    for (;c>0;c--)
    {
        ...
        {
            PORTD=(system6x8[(unsigned short) (*tx-32)*6+d]);
            LATB|=(0b00010000);
            _delay((unsigned long)((8)*(8000000/4000000.0)));;
            LATB&=~(0b00010000);
            _delay((unsigned long)((8)*(8000000/4000000.0)));;
...
void glcd_adv_systext(uint8_t x,uint8_t y,const char *tx,uint8_t c)
{
    ...
    for (; c > 0; c--) {
        ...
        LATB&=~(0b00000100);
        PORTD=((uint8_t) (0b10111000 | (((y >> 3)&7))+1));
        LATB|=(0b00010000);
        _delay((unsigned long)((8)*(8000000/4000000.0)));;
        LATB&=~(0b00010000);
        _delay((unsigned long)((8)*(8000000/4000000.0)));;

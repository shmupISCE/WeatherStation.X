...
# 12 "OPT3001.c"
uint16_t OPT3001_Read2ByteRegister(uint8_t reg_addr){
    uint16_t buffer = I2C1_Read2ByteRegister((0x44), reg_addr);
    return buffer;
}
...
void OPT3001_Write2ByteRegister(uint8_t reg_addr, uint16_t data_tw){
    I2C1_Write2ByteRegister((0x44), reg_addr, data_tw);
}
# 34 "OPT3001.c"
void OPT3001_ReadnReplace(uint16_t reg_addr, uint16_t value){
...
void OPT3001_full_scale_mode(void){
    ...
    I2C1_ReadDataBlock((0x44), (0x01), current_reg_val, 2);
    buffer = (buffer | current_reg_val[0]) << 8;
    buffer |= current_reg_val[1];
    buffer |= 0x00CE;
    I2C1_Write2ByteRegister((0x44), (0x01), buffer);
}

void OPT3001_init(void){
    I2C1_Write2ByteRegister((0x44), (0x01), 0xCE10);
}
...
uint16_t read_data(void){
    ...
    I2C1_ReadDataBlock((0x44), (0x00), buffer, 2);
